...
* **Копирование между вкладками:** откройте планировщик в нескольких вкладках (или окнах, или сайт и сохранённый `floorplaner.html`), выделите объекты, нажмите `Ctrl+C` (или `Ctrl+X`) и вставьте `Ctrl+V` в другой вкладке — объекты встанут под курсор, на текущий этаж, со стенами вместе с окнами и дверями. Работает через общее хранилище вкладок и системный буфер обмена.
* **Группы:** выделите несколько стен (или любых объектов) — `Shift`+клик или рамкой — и нажмите `Ctrl+G` («Сгруппировать»). Дальше клик по любой стене выделяет всю группу, и с ней можно работать как с одним объектом: перетащить (примыкающие стены подтянутся), сдвинуть стрелками или на точное расстояние, повернуть, отразить, дублировать, скопировать, удалить, поменять материал, толщину и высоту сразу у всех. `Alt`+клик выбирает одну стену внутри группы, `Ctrl+Shift+G` — разгруппировать.
...
* **Постройки произвольных размеров:** дом-контур, гараж, навес для авто (одно-, двухместный или пристроенный), сарай, баня, беседка, теплица. **Крышу постройки можно выбрать**: двускатная, вальмовая, односкатная, плоская или арочная (у теплиц и навесов), материал (в том числе сотовый поликарбонат), уклон, направление конька или высокой стороны. Тип крыши виден на плане (конёк, рёбра, стрелки ската) и в 3D.
* **Покрытия:** асфальт, бетон, щебень, плитка, газон — вид зоны или кнопки «Заасфальтировать», «Бетон», «Щебень» в свойствах выделенной зоны. Покрытие ровное, без бордюров (для границы участка создаётся отдельная зона по тому же контуру) и попадает в смету в раздел «Благоустройство». У дорог бордюр включается и выключается в свойствах.
* **Крыльцо, веранда, терраса:** открытая, с ограждением, закрытая остеклённая или закрытая утеплённая; с крышей (козырьком) или без; пристроенная к дому (односкатная крыша от стены) или отдельно стоящая (двускатная); высота площадки и ступени считаются сами (подъём, проступь); стороны со ступенями и с ограждением (остеклением, стенами) выбираются кнопками — спереди, слева, справа, сзади, ступени — по центру стороны или у края. Площадка рисуется под стенами, так что дверь, открывающаяся на крыльцо, видна. Крыша крыльца, веранды и террасы выбирается так же, как у построек: односкатная (по умолчанию у пристроенных — к стене дома, без свеса с его стороны), двускатная, вальмовая, плоская или арочная, материал, уклон, направление конька. Всё настраивается в свойствах, видно на плане и в 3D; веранды под крышей идут в площадь застройки.
* **Погреб, подпол, смотровая яма:** группа «Погреба и ямы» в библиотеке. В свойствах — глубина, лестница (ступени или стремянка) и сторона спуска, ширина, сверху люк, открытая яма или погребница. Лестница считается сама (число ступеней, подъём, проступь), показан объём выемки грунта. На плане — стенки, ступени со стрелкой «вниз», люк и глубина; в 3D открытая яма вырезана в газоне, видны стенки, дно и ступени, а в прогулке в неё можно спуститься.
...
| Копировать / Вырезать / Вставить / Дублировать | `Ctrl+C` / `Ctrl+X` / `Ctrl+V` / `Ctrl+D` |
| Сгруппировать / разгруппировать | `Ctrl+G` / `Ctrl+Shift+G` |
| Один объект внутри группы | `Alt`+клик |
