...
### 3D-вид
Кнопка **3D** (или клавиша `3`): модель дома со стенами, проёмами и остеклением, перекрытиями, крышей, мебелью, постройками, деревьями и участком. Освещение соответствует положению солнца на выбранные дату и время. Модель можно вращать, приближать и сдвигать, показывать или скрывать верхние этажи, крышу и мебель. Из 3D-вида можно сохранить картинку, OBJ или IFC.
